...
:construction: This is a working branch, currently in active development. For a stable version of Bayesian Nonparametric stepfinding, refer to the LabPresse fork [https://github.com/LabPresse/bnp-step.git](url) . :construction:
